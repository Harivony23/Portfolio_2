      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 font-mono text-sm uppercase tracking-widest">
            ...
            <a href="Harivony23/Portfolio_2/public/Harivony_CV.pdf" download className="bento-box hover:bg-white/5 px-8 py-4 flex items-center justify-center gap-3 transition-colors text-white">
              <Download size={18} />
              <span>Mon_CV</span>
            </a>
          </div>
